...
\begin{align}
 \frac{G_{contra}}{G_{ipsi}}&=-\frac{\Lambda+\frac{\rho c\omega \cot kL}{\pi a^2_{cyl}}}{\frac{\rho c\omega \csc kL}{\pi a^2_{cyl}}}\\
			     &=-\frac{\pi a^2_{cyl}\Lambda}{\rho c\omega}\sin kL- \cos kL
\end{align}
