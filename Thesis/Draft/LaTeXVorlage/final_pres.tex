...
\end{equation}
\end{exampleblock}
\begin{variableblock}{}{bg= blue!10,fg=black}{}
...
\begin{frame}
\frametitle{Separated Equations and their Solutions}
...
\begin{variableblock}{Bessel Prime Zeros}{bg= gray!20,fg=black}{}
\begin{itemize}
...
\frametitle{General Solution}
 \onslide<1>{\begin{exampleblock}{Pressure Modes}
  \begin{align}
   &p(x,r,\phi,t)=\displaystyle\sum^{\infty}_{q=0,s=0}p_{\mathrm{qs}}(x,r,\phi)e^{j\omega t}\\
   &p_{\mathrm{qs}}(x,r,\phi)=\left[A_{\mathrm{qs}}e^{j\zeta_{\mathrm{qs}}x}+B_{\mathrm{qs}}e^{-j\zeta_{\mathrm{qs}}x}\right]\cos q\phi J_q(\nu_{\mathrm{qs}}r/a_{\mathrm{cyl}})
  \end{align}
 \end{exampleblock}
 $\zeta_{\mathrm{qs}}=\sqrt{k^2-\nu^2_{\mathrm{qs}}/a^2_{\mathrm{cyl}}}$}
 
\onslide<2>{\begin{variableblock}{Plane Wave Mode}{
bg= blue!10,fg=black}{}
 \begin{equation}
  p_{\mathrm{00}}(x,r,\phi;t)=\left[A_{00}e^{jkx}+B_{00}e^{-jkx}\right]e^{j\omega t}
 \end{equation}
\end{variableblock}
}
\end{frame}
...
\begin{variableblock}{Membrane parameters}{bg= blue!10,fg=black}{}
  \begin{tabular}{l l}
...
\begin{frame}
 \frametitle{Free-Undamped Membrane}
 $\alpha\rightarrow 0$, $\Psi\rightarrow 0$
...
%  \end{exampleblock}}
% 
\begin{variableblock}{Separation Ansatz}{
bg= blue!10,fg=blue!75}{}
\begin{equation}\label{mseparationansatz}
 u(r,\phi;t)=f(r)g(\phi)h(t)
\end{equation}
\begin{itemize}
 \item Same set of equations as for pressure case.
\end{itemize}
