...
\begin{frame}
 ...
 \onslide<1->{\begin{variableblock}{}{bg= blue!5,fg=black}{bg= blue!5,fg=blue!75}
  \begin{equation}
  u_{0/L}=\displaystyle\sum^{\infty}_{m=0,n=1}\Omega_{\mathrm{mn}}C^{0/L}_{\mathrm{mn}}u_{\mathrm{mn}}(r,\phi)e^{j\omega t}
 \end{equation}
 \end{variableblock}
 }
...
\begin{frame}
 ...
 \onslide<2->{\begin{variableblock}{Approximate}{bg= blue!5,fg=black}{bg= blue!5,fg=blue!75}
  \begin{equation}
 U_{0/L}=S^{0/L}(t)=\vcentcolon\int dSU_{0/L}
 \end{equation}
 \end{variableblock}}
\end{frame}
...
\subsection{Internal Amplitude Difference}
