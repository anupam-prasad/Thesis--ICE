...
\footnotesize
 \begin{itemize}
  \item Plot of $20\mathrm{Log}_{\mathrm{10}}\left| \dot{S}^0/\pi a^2_{\mathrm{cyl}}\right|$ w.r.t direction frequency.
...
\begin{frame}[t]
%\frametitle{Vibration Amplitude}
\noindent Vibration Amplitude - Spectrum
\begin{variableblock}{}{bg= white,fg=black}{bg= white,fg=blue!75}
\begin{figure}[ht!]
 \centering 
 \includegraphics[width = 11 cm]{Diagrams/Plots/tokayipsivscontrafull.png}
\end{figure}
\end{variableblock}
\begin{exampleblock}{}
\footnotesize
 \begin{itemize}
  \item Plot of $20\mathrm{Log}_{\mathrm{10}}\left| \dot{S}^0/\pi a^2_{\mathrm{cyl}}\right|$, against frequency for $\theta=90^\circ$.
  \item $\left|p_0\right|=\left|p_L\right|=1$ Pa.
 \end{itemize}
\end{exampleblock}
\end{frame}
...
\onslide<1->{\begin{exampleblock}{}
 ...
 \onslide<2->{\begin{variableblock}{}{bg= blue!5,fg=black}{bg= blue!5,fg=blue!75}
	      \begin{itemize}
               \item We still need functions that quantify the directional and frequency dependence of the system.
               \end{itemize}
              \end{variableblock}}
