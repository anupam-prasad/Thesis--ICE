...
\begin{subfigure}{1.0\textwidth}
 \centering
  \includegraphics[width=.3\linewidth]{Diagrams/SectorMembraneModes/membrane_modes_21.png}
   \caption{}
\end{subfigure}
\begin{subfigure}{1.0\textwidth}
\centering
...
% \begin{figure}[ht!]
%  \centering
%  \includegraphics[width=.35\linewidth]{Diagrams/SectorMembraneModes/membrane_modes_21.png}
