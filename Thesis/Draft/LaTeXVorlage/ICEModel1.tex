...
As a result of this, the tympanum cannot vibrate freely. 

For most frequencies, the extracolumella vibrates as a completely stiff
bar. It was shown in \cite{manleygecko2} that the extracolumella begins to flex at higher frequencies. This is illustrated in \ref{extracolumellaflection}.

\begin{figure}[ht]
 \centering
 \includegraphics[width=.7\linewidth]{Diagrams/manleyextracolumellaflection.png}
 \caption[Extracolumella Flection]{Operation of the middle ear lever in geckos. The inferior process of the extracolumella (A-C) 
