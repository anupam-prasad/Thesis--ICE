...
as illustrated in \ref{extracolumellaflection}.
...
\subsection{Head Model and External Sound Input}
...
in the hearing range of the larger lizards (eg. Tokay gecko) is around $70$mm ($4000$ Hz) and is around $50$mm ($7000$ Hz) for
the smaller lizards (eg. Hemidactylus).
...
as the \textit{contralateral} ear and will be denoted by a subscript $L$.
