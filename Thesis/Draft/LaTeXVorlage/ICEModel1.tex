...
\end{align}
where $a_{cyl}$ is the cylinder radius and $L$ is the interaural distance.
\begin{figure}[ht]
\begin{center}
\begin{subfigure}{1.0\textwidth}
 \centering
  \includegraphics[width=.5\linewidth]{Diagrams/oldCylinder.png}
   \caption[Previous ICE Model Cylinder]{The previous realization of the ICE model.}
  \label{oldICE}
\end{subfigure}

\begin{subfigure}{1.0\textwidth}
\centering
  \includegraphics[width=.75\linewidth]{Diagrams/newCylinder.png}
  \caption[New ICE Model Cylinder]{The current realization of the model.}
  \label{newICE}
  \end{subfigure}
  \caption[Previous and Current ICE Model Realizations]{}
\end{center}
\end{figure}
...
\begin{figure}[ht]
 ...
 \caption[Tympanic Membrane Model]{Model of the loaded tympanice membrane. The lightly shaded region is a linear elastic membrane whereas the darkly shaded region 
 represents the extracolumella.}
\end{figure}
...
The extracollumella is modelled as a triangular plate of infinite mass which constrains the membrane displacement to go to zero at $phi=\beta$
