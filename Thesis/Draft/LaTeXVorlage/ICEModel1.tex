...
In order to make the system more analytically tractable we will, as before, study a geometry in which a pair of circular
membranes are coupled through a cylindrical cavity; albeit with a few modifications. The cylindrical geometry allows us to accurately calculate the 
pressure distribution inside the cavity at both low and high frequencies. At the end of this chapter, we will
have the main objects which describe the vibration of the coupled membranes as a function direction and frequency. Furthermore,
these quantities will be conducive to comparison with observed data.
...
\centering
  ...
  The darkly shaded region corresponds to the extracolumella.}
\end{center}
\end{figure}
...
middle ear. Unlike humans, lizards possess only a single middle ear bone, the \textit{columella},
