...
vibration profiles, the ipsi- and contraleteral filters and the pressure coefficients. The main equations
...
tympanic membranes driven by internal and external pressures. Additionally, we also have another $2^{nd}$-order PDE - the $3D$ wave
equation - that describes the pressure distribution inside the cylindrical cavity.


We first find an expression for the pressure distribution in the cylindrical cavity and for the membrane vibrations subject to an external stimulus. We then apply the 
