...
Fundamental frequency (first eigenfrequency) of the tympanic membrane, $\omega_{01}$ & $2.8$kHz & $1.05$kHz\\
...
The contour plots serve the purpose of giving us the simultaneous frequency and direction dependence of the iLDs well but the 
...
As we have previously seen, the iLDs can be used as directional cues at relatively higher frequencies. The hearing range of geckos
...
a fully contralateral ($-90^\circ$) stimulus for both species with respect to frequency.

\begin{figure}[ht!]
\centering
  \includegraphics[width=.8\linewidth]{Diagrams/Plots/iTD/both.png}
