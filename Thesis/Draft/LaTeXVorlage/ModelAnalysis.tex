...
\begin{equation}
ITD=\frac{Arg(pL/p0)}{\omega}=1.5\frac{L}{c}
\end{equation}
Due to the 
...
ipsilateral and contralateral directions. This suggests that iLDs may work better as directional cues at higher frequencies. In figure \ref{iLDspectrum}
...
is clearly shown - the house gecko has a maximum difference of $30$ dB at around 3kHz and the Tokay gecko iLD peaks at $36$dB at around 1kHz.
\begin{figure}[ht!]
\centering
...
\begin{figure}[ht!]
\centering
  \includegraphics[width=.8\linewidth]{Diagrams/Plots/iLD/iLDspectrumboth2.png}
  ...
  The bandpass nature of the iLDs is clearly shown with a peaks at around $3$kHz for the house gecko and around $1$kHz for the Tokay gecko and is consistent with observations;\cite{dalsgaardmanley1}, \cite{dalsgaardmanley2}. }
  \label{iLDspectrum}
\end{figure}
...
well for both animals, albeit for different frequency ranges. For the case of the house gecko, the ITD is around $43.7\mu$s and the resultant iTD between 
$500$Hz and $2.7$kHz is around three times as much ($131\mu$s). For the Tokay gecko, the ITD is around $96.2\mu$s which results in an iTD that is around
$3.6$ times the ITD ($346\mu$s). These values stay more or less constant upto a certain frequency (around the first eigenfrequency of the membrane) and
abruptly drop. As the frequency increases beyond this point, the iTD converges to the ITD.
...
\centering
  ...
  and the beige filled region to the iLD regime. In the unfilled region in the middle there is a possibilty of using both cues.  The values have been scaled to demonstrate the different
...
of the iLDs (see Fig. \ref{iLDspectrum}) suggests that one of the membrane eigenmodes dominates $\Lambda$. 
