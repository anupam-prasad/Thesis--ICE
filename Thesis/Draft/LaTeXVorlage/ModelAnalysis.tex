...
\begin{figure}[ht!]
 ...
 in dB. $x$-axis denotes direction in degrees and the $y$-axis frequency in kHz. The experimental values are taken from Christensen-Dalsgaard \cite{dalsgaardmanley2}.}
