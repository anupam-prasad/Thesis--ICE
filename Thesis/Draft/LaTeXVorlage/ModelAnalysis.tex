...
we compare the total velocity of the contralateral membrane ($\dot{S}^L$) with membrane velocity measured using laser vibrometry
in \cite{dalsgaardmanley2}.
...
\begin{figure}[ht!]
 ...
 in dB re $1$ mm/(s Pa), i.e. the ratio vibration amplitude with reference to a vibration velocity of $1$ mm/s with an input pressure of $1$ Pa. On the $x$-axis we have
...
\end{figure}
The same comparison is illustrated for the Tokay gecko in Fig. \ref{tokayvibampfull} (data from \cite{dalsgaardmanley1}).
\begin{figure}[ht!]
 \centering
