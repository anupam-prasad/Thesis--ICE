...
terrestrial vertebrates, these take the form of \textit{tympani} a pair of thin vibrating
membranes which are a component of the mechanical part of the auditory system.
Depending on the species, there may be an apparatus that focusses and amplifies the sound waves. In
humans for example, this function performed by the external ears or pinnae.

The primary focus of this thesis is sound localization in terrestrial vertebrates - specifically
