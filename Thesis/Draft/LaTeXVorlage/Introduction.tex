...
animals although interesting, are beyond the scope of this thesis. We will however briefly discuss the neuronal processing of the binaural cues
...
of the pinnae which affects the spectra of sounds reaching the ear (monoaural cues). In effect, for binaural hearing the ears are independently activated by sound pressures
...
to localize the source whereas at lower frequencies the time cues are mainly used.
...
These animals possess cochlear nucleii (collections of neurons that receive input from the cochlear nerve) that are specialized either for
...
sounds come from the excitatory ear. The inhibitory ear, on the other hand sits on the far side of the head resulting in a reduced inhibition.
\subsubsection*{}
