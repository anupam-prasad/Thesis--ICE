...
as the iTD (Internal Time Difference) which measures the delay between the membrane vibrations and the iAD (Internal Amplitude
Difference) which measures the difference in their vibration amplitudes; Sec. \ref{hearingcuessection}. Due to the difficulty of measurement of certain membrane
