...
animals that have their eardrums connected through a large mouth cavity and the emergence of
 directionality in the response of such systems. The questions posed by the neuronal processing of auditory stimuli in these
...
\begin{figure}
 \centering
 \includegraphics[width=0.5\linewidth]{Diagrams/lizardheadcrosssection.jpeg}
 \caption[Cross Section of a Lizards Head]{Diagram of the cross-section of a lizard’s head (\textit{sceloporus}). Figure taken from \cite{dalsgaardmanley1}.}
