...
{%
  \begin{beamercolorbox}[ht=3.5ex,dp=1.125ex,%
    ...
    \flushleft\textbf{\insertsectionnavigationhorizontal{\textwidth}{\hskip0pt plus1fill}{\hskip0pt plus1fill}}
    %\insertsectionhead
  \end{beamercolorbox}%
...
\begin{itemize}
 ...
 \begin{column}{.6\textwidth}
  \centering
\includegraphics[width = 3.5cm]{Diagrams/Presentation/BoundaryConditions/besselprimezeros.png}
 \end{column}
\end{columns}
\end{variableblock}}
...
% \end{exampleblock}
\vfill
\textcolor{blue}{Boundary Conditions}
 \onslide<2->{\begin{exampleblock}{$\phi$-direction: $u(r,\beta;t)=u(r,2\pi-\beta,t)=0$}
 \begin{columns}
...
\noindent$\widetilde{C}_{\mathrm{mn}}$ determined from the membrane displacement at $t=0$.
...
\begin{frame}
 ...
 \end{column}
   ...
   \begin{column}{.5\textwidth}
   %\centering
\includegraphics[width=5.2cm]{Diagrams/Presentation/BoundaryConditions/velocity1.png}
 \end{column}
 \end{columns}
 ...
 \end{column}
   ...
   \begin{column}{.5\textwidth}
   %\centering
\includegraphics[width=5.2cm]{Diagrams/Presentation/BoundaryConditions/velocity2.png}
 \end{column}
 \end{columns}
  \end{variableblock}}
\end{frame}
...
\begin{exampleblock}{}
\begin{itemize}
\item[] $\textcolor{red}{f_0}=\omega_{01}/2\pi$, $\alpha=\omega_{01}/2\textcolor{red}{Q}$.
\end{itemize}
\end{exampleblock}
     \end{column}
