...
We have listed the main parameters and functions used in our analysis (including the geometry parameters) in Table \ref{parametertable}.% and Table \ref{functiontable}.
% \begin{minipage}{\linewidth}
% \renewcommand{\arraystretch}{1.1}
% %\caption{Parameters and Functions used in the ICE Model} \label{parametertable} 
% \centering
...
\begin{equation}\label{pressurewaveeqn}
 ...
 +\frac{1}{r^2}\frac{\partial^2 p(x,r,\phi,t)}{\partial \phi^2}+\frac{\partial p(x,r,\phi,t)}{\partial x^2}
\end{equation}
...
\begin{equation}\label{specificpressure3}
 p_{\mathrm{qs}}(x,r,\phi;t)=\left[A_{\mathrm{qs}}e^{j\zeta_{\mathrm{qs}}x}+B_{\mathrm{qs}}e^{-j\zeta_{\mathrm{qs}}x}\right]f_{\mathrm{qs}}(r,\phi)e^{j\omega t}
\end{equation}
...
\begin{equation}\label{membraneequation1}
 \begin{split}
 -\frac{\partial^2 u(r,\phi;t)}{\partial t^2}-2\alpha\frac{\partial u(r,\phi;t)}{\partial t}+c^2_M \left[\frac{1}{r}\frac{\partial}{\partial r}\left(r\frac{\partial u(r,\phi,t)}{\partial r}\right)\right. +\frac{1}{r^2}&\left.\frac{\partial^2 u(r,\phi,t)}{\partial \phi^2}\right]
